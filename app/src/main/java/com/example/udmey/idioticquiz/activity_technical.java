...
public class activity_technical extends AppCompatActivity {

    private technicalquestion mQuestion = new technicalquestion();
    ...
    private void updateQuestion() {
        if (mQuestionsNumber < mQuestion.getLength()) {
            ...
            Intent intent = new Intent(activity_technical.this, activity_result.class);
